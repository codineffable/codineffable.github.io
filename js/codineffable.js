...
var url = window.location.href;  
  ...
  if(ur5=="en")
      {
   $("#submit-form").val("Connecting to database...");
    }
    else if(ur5=="es")
    {
      $("#submit-form").val("Conectando con la base de datos...");
    }
    ...
    var config = {
    apiKey: "AIzaSyACipjO9l43zRA8LMGTStZf28ALUtVF5-Q",
    authDomain: "codineffable-88bec.firebaseapp.com",
    databaseURL: "https://codineffable-88bec.firebaseio.com",
    projectId: "codineffable-88bec",
    storageBucket: "codineffable-88bec.appspot.com",
    messagingSenderId: "793701788543"
  };
  firebase.initializeApp(config);
  var database = firebase.database();
  var reqList = database.ref("requerimiento");
  var newReq = reqList.push();
...
newReq.set(
  ...
  if (error) {
    if(ur5=="en")
      {
    $("#submit-form").val("Error! Try again later!");
    }
    else if(ur5=="es")
    {
       $("#submit-form").val("Error! Intente mas tarde!");
    }
  } else {
    if(ur5=="en")
      {
   $("#submit-form").val("Sent! We will check it soon!");
    }
    else if(ur5=="es")
    {
